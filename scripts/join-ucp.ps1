...
# Join cluster
$PRIVATE_IP="172.31.18.51";
$MANAGER_IP="18.194.170.193";
$MANAGER_PUBLIC_DNS="ec2-18-194-170-193.eu-central-1.compute.amazonaws.com";
...
$AUTH_TOKEN=((Invoke-WebRequest -UseBasicParsing -Body $Body -Uri "https://$MANAGER_PUBLIC_DNS/auth/login" -Method POST).Content) | ConvertFrom-Json | select auth_token -ExpandProperty auth_token;
